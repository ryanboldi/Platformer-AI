class Population {
    ...
    fitness() {
        ...
        for (let i = 0; i < this.genomes.length; i++) {
            ...
            if (this.genomes[i].fitness > this.bestFitness) {
                this.bestFitness = this.genomes[i].fitness;
    ...
    makeNext() {
        ...
        for (let i = 0; i < this.species.length; i++) {
            ...
            let offspring = Math.round((this.species[i].averageFitness / tot_avg_fitness) * (popSize - interspecies.length - this.species.length)); //how many offspring this species is allowed. 
